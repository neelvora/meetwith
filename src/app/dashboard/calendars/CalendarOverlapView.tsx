...
import { ChevronLeft, ChevronRight, RefreshCw, Calendar as CalendarIcon, ChevronDown, ChevronUp } from 'lucide-react'
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <h2 className="text-lg font-semibold text-white">Your Week at a Glance</h2>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <h3 className="text-base font-medium text-white min-w-[160px] text-center">
